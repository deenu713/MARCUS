...
#include "PUBGM_Lobby_Left_Light_3D_UIBP_structs.hpp"
...
// BlueprintGeneratedClass Lobby_Left_Light_3D_UIBP.Lobby_Left_Light_3D_UIBP_C
// 0x0070 (0x0350 - 0x02E0)
class ALobby_Left_Light_3D_UIBP_C : public AActor
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!pStaticClass)
			 pStaticClass = UObject::FindClass("BlueprintGeneratedClass Lobby_Left_Light_3D_UIBP.Lobby_Left_Light_3D_UIBP_C");
		return pStaticClass;
	}
