...
#include "PUBGM_CS_WeapGun_Rifle_762_ADS_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		...
		if (!pStaticClass)
			 pStaticClass = UObject::FindClass("BlueprintGeneratedClass CS_WeapGun_Rifle_762_ADS.CS_WeapGun_Rifle_762_ADS_C");
		return pStaticClass;
	}
